...
VALID_TARGETS = $(64K_TARGETS) $(128K_TARGETS) $(256K_TARGETS) $(512K_TARGETS)

VCP_TARGETS = CC3D ALIENFLIGHTF3 CHEBUZZF3 COLIBRI_RACE LUX_RACE MOTOLAB RCEXPLORERF3 SPARKY SPRACINGF3EVO SPRACINGF3MINI STM32F3DISCOVERY SPRACINGF1OSD SPRACINGF3OSD NUCLEO
